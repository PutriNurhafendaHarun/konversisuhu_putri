...
fahrenheit f = new fahrenheit();
    ...
    private void initComponents() {
        ...
        Fcalcius.setBackground(new java.awt.Color(255, 51, 255));
        from.add(Fcalcius);
        Fcalcius.setText("CALCIUS");

        Ffahrenheit.setBackground(new java.awt.Color(255, 51, 255));
        from.add(Ffahrenheit);
        Ffahrenheit.setText("FAHREINHEIT");

        Fcalvin.setBackground(new java.awt.Color(255, 51, 255));
        from.add(Fcalvin);
        ...
        Tcalcius.setBackground(new java.awt.Color(255, 51, 255));
        to.add(Tcalcius);
        Tcalcius.setText("CALCIUS");

        Tfahreinheit.setBackground(new java.awt.Color(255, 51, 255));
        to.add(Tfahreinheit);
        Tfahreinheit.setText("FAHREINHEIT");

        Tcalvin.setBackground(new java.awt.Color(255, 51, 255));
        to.add(Tcalvin);
